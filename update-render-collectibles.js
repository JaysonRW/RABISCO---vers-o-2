...
const regex = /public renderCollectibles\(ctx: CanvasRenderingContext2D, items: any\[\]\) \{[\s\S]*?ctx\.restore\(\);\s*\}/;

const newRender = `public renderCollectibles(ctx: CanvasRenderingContext2D, items: any[]) {
    ctx.save();
