...
const regex = /\{\/\* INVENTORY \*\/\}[\s\S]*?\{\/\* GRIMOIRE \*\/\}/;

const newCode = `{/* INVENTORY */}
            {activeTab === 'INVENTORY' && (
              <div className="flex flex-col gap-6 animate-in slide-in-from-right-8 fade-in duration-300 pb-20">
                {stats.inventory && stats.inventory.length > 0 ? (
                  Object.entries(
                    ...
                    <div key={category} className="flex flex-col gap-3">
                      <h3 className="text-stone-400 font-['Cinzel'] text-xl tracking-widest border-b border-stone-800/80 pb-2 mb-1">
